...
const Data = () => {
  const { sub, year } = useApiContextProvider()
  console.log('hello')
  const tabs = [
    sub == 'Mathematics' &&
      year == 'B.Tech CSE 1st Semester' && {
        video: [
          {
            key: 1,
    ...
    sub == 'Electrical & Digital Electronics' &&
      year == 'B.Tech CSE 1st Semester' && {
        video: [
          {
            key: 1,
          ...
          {
            key: 5,
            heading: 'SEMICONDUCTOR TYPE | Intrinsic Extrinsic p-Type n-Type |',
            description:
          ...
          {
            key: 6,
            heading: 'conductor insulator semiconductor',
            description:
          ...
          {
            key: 7,
            heading: 'All about Forward Bias',
            description:
          ...
          {
            key: 8,
            heading: ' All about Reverse bias ',
            description:
          ...
          },
          {
            ...
            link: 'https://www.youtube.com/watch?v=W_4rBZdd41Q&list=PL3qvHcrYGy1uF5KAGntUITTJ85Dm3Dtdy&index=5',
          },
          {
            key: 10,
            heading:
              'Photo Diode (Construction & Working) Special Purpose Diodes (Basic Electronics)',
            description:
...

          {
            ...
            link: 'https://youtu.be/qVwEVXf3CBQ?si=Go_1C_oDuR-9z1Z2',
          },
          {
            key: 12,
            heading:
            ...
            link: 'https://youtu.be/7ITiehTTh-o?si=biSt8YIpolzsHOAy',
          },

          {
            ...
            description:
              'a suitable L and C network can effectively filter out the A.C component from the rectified wave.',
            link: 'https://youtu.be/DBw2sNphRME?si=v8zXdz1LHlPHMZfe',
          },

          {
            key: 14,
            heading: 'Introduction to Transistor',
            description:
              'A transistor is a type of semiconductor device that can be used to conduct and insulate electric current or voltage. ',
            link: 'https://youtu.be/08jcU8rb9SU?si=h_6l-AoOAL6T6frK',
          },
          {
            key: 15,
            heading: 'Working of Transistor (NPN)',
            description:
            ...
            link: 'https://youtu.be/tPE26DO3cDw?si=a9ar5g1s0UOvxu8g',
          },
          {
            key: 16,
            heading:
              'Operation of PNP Transistor - Bipolar Junction Transistor',

            description:
              'In a PNP transistor, the base current which enters into the collector is amplified',
            link: 'https://youtu.be/Lx3ApgmyQlc?si=-1jDfPCanifda9LN',
          },

          {
            key: 17,
            heading: 'MOSFET , EMOSFET , DMOSFET ',
            description:
            ...
            link: 'https://youtu.be/X4_8dh-J4ik?si=YYRGX4crLGd-RV0_',
          },
        ],
      ...
      year == 'B.Tech CSE 1st Semester' && {
        video: [
          ...
          },
          {
            ...
            description: 'What is Projection of Point?',
          ...
          },
          {
            ...
            description: '3D projections of lines',
          ...
          },
          {
            ...
            description: 'Introduction to Projection of Lines',
          ...
          },
          {
            ...
            description: 'Problems on Projection of point ',
          ...
          },
          {
            ...
            description: 'Problems on Projection of lines',
          ...
          },
          {
            ...
            description: 'Projection of Lines | Problem Series | Part 2 ',
          ...
          },
          {
            ...
            description: 'Projection of Lines | Problem Series | Part 3 ',
          ...
          },
          {
            ...
            description: 'Projection of Planes Idea & Standard Procedure',
          ...
          },
          {
            ...
            description: 'Problems of Projection of Planes',
          ...
          },
          {
            ...
            description: 'Problems of Projection of Solids ',
          ...
          },
          {
            ...
            description: 'Concepts & Problems of Section of Solids',
          ...
          },
          {
            key: 29,
            heading:
              'Conic Sections | Part 9 | Problem 2 on Parabola in Rectangle Method',
            description:
          ...
          },
          {
            key: 30,
            heading:
              'Conic Sections | Part 10 | Problem 3 on Parabola in Rectangle Method',
            description:
          ...
          },
          {
            key: 31,
            heading:
              'Conic Sections | Part 11 | Problem 4 on Parabola in Tangent Method',
            description:
          ...
          },
          {
            ...
            description: 'Construction of Hyperbola in General Method',
            link: 'https://youtu.be/fWOJIxpTVa8?si=gOfm4MyC0Fo5i5t4',
          },
          {
            key: 33,
            heading: 'Conic Sections | Part 14 | Problems on Hyperbola ',
            description: 'Problems and Solutions on Construction of Hyperbola',
            link: 'https://youtu.be/V5qsFot9dMQ?si=OTIzp3gd1KsjZtsE',
          },
          {
            key: 34,
            heading:
              'Conic Sections | Part 15 | Hyperbola in Arcs of Circles Method ',
            description: 'Construction of Hyperbola in Arcs of Circles Method ',
            link: 'https://youtu.be/_CeQjBs5AT8?si=omlj6HEwRo0ErUIv',
          },
          {
            key: 35,
            heading:
              'Conic Sections | Part 16 | Tangent and Normal to Different Conic Sections ',
            description:
      ...
      year == 'B.Tech CSE 1st Semester' && {
        video: [
          ...
          },
          {
            ...
            description: 'some basic concepts related to quasistatic process.',
          ...
          },
          {
            key: 9,
            heading:
              "Atomic and Molecular Structure|Dalton's and Rutherford Atomic Model",
            description:
          ...
          },
          {
            key: 12,
            heading:
              'Atomic and Molecular Structure|Shape of Orbitals and Hydrogen Energy',
            description:
          ...
          },
          {
            key: 16,
            heading:
              'Atomic and Molecular Structure|Molecular Orbital Energy Level For Homonuclear Diatomic Molecules',
            description:
          ...
          },
          {
            key: 17,
            heading:
              'Atomic and Molecular Structure|Molecular Orbital Energy Level For Heteronuclear Diatomic Molecules',
            description:
          ...
          },
          {
            ...
            description: 'Basic introduction of spectroscopy',
          ...
          },
          {
            key: 20,
            heading:
              'Instrumentation and application of UV visible spectroscopy',
            description:
          ...
          },
          {
            key: 24,
            heading:
              'periodic properties (variation in s p d f orbitals energies)',
            description:
          ...
          },
          {
            ...
            description: 'Exploring the arrangement of electrons in an atom',
          ...
          },
          {
            key: 30,
            heading:
              ' periodic properties-Oxidation State and oxidation number',
            description:
          ...
          },
          {
            ...
            description: 'basic introduvtion on Isomerism and Isomers',
            link: 'https://youtu.be/2Ou5cPT58MA?si=cPYroBtA_xfEIxZv',
          },
          {
            key: 32,
            heading:
              'Stereochemistry-Terms used in Optical Activity, Optically Active Compound, Enantiomers',
            description:
          ...
          },
          {
            key: 34,
            heading:
              'Stereochemistry-Without, With Chiral C-Atom, Biphenyl, Allenes',
            description:
          ...
          },
          {
            key: 37,
            heading:
              'Stereochemistry-E Z, Nomenclature Of Geometrical Isomers ',
            description: 'the orientation of a functional group in a compound',
            link: 'https://youtu.be/DftQyhm_FA4?si=NAuQDHpEFhuaBSPt',
          },
          {
            key: 38,
            heading: 'Stereochemistry-chiral drugs  ',
            description: 'importance of chiral drugs',
            link: 'https://youtu.be/l1IIftU0BmU?si=AgrjKExNEmqiFzUo',
          },
          {
            key: 39,
            heading: ' organic reactions',
            description: 'chemical reactions involving organic compounds',
